...

{
  ...
  /*  static void Main()

    {
        ...
        // It will Create a new String Objects in memory every Time
        //You modify it because string is immutable
        //StringBuilder -- Which is mutable class in the System.Text namespace used for  memory especially when you do some modification like adding
...
// if values are same most of the time reference value will be same
