...
namespace MvcExample.Controllers
{
    public class CatagoriesController : Controller
    {
        ...
        public CatagoriesController(Ecomcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // View ke liye extra data bhejna
            //   ViewBag.Title = "All Categories (using ViewBag)";
            ...
            //  ViewData["Title"] = "All Categories (using ViewData)";
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] Catagory catagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description")] Catagory catagory)
        {
            if (id != catagory.Id)
            {
                return NotFound();
